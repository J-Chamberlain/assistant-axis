...
- Three-model comparison (Gemma, Qwen, Llama) shows Spearman 0.947 between Qwen and Llama versus 0.550 between Gemma and Llama. Does adding Mistral or Falcon to the comparison clarify whether Gemma or Qwen-Llama represents the modal post-training geometry?
...
- A base-vs-instruct comparison for Gemma shows Spearman -0.441, indicating near-complete geometric inversion by RLHF. Does the same inversion appear in Qwen and Llama, or is the magnitude of RLHF reorganization model-specific?
