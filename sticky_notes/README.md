...
Research notes, open questions, and write-up reminders.
One file per note. Add new notes by creating a new dated file.
Do not edit existing notes in place — append a dated update section.

To fetch any note in a Claude chat session, use its raw GitHub URL:
https://raw.githubusercontent.com/J-Chamberlain/assistant-axis/master/sticky_notes/FILENAME.md

| File | Topic | Paper | Priority |
|------|-------|-------|----------|
| 2026-05-07_haidt_moral_foundations.md | Haidt moral foundations empirical test | 2 | medium |
| 2026-05-07_multi_agent_interactions.md | Multi-agent persona interaction simulations | 2 | medium |
| 2026-05-07_relational_mirror.md | Relational mirror / conflict simulation | 2 | low |
| 2026-05-07_sistine_chapel_metaphor.md | Sistine Chapel visual metaphor | essay 2 | write-up |
| 2026-05-07_moby_heart.md | Moby / outsourcing introspection | essay 2 | write-up |
| 2026-05-07_trickster_madness.md | Trickster: madness is the method | 2 | low |
| 2026-05-07_poet_epigraph.md | Poet section epigraph | essay 2 | write-up |
| 2026-05-07_consciousness_layer_transition.md | Consciousness at layer transition | essay 2 | speculative |
| 2026-05-07_275_personas_methodological.md | 275 personas methodological note | 2 | medium |
| 2026-05-07_base_model_geometry.md | Base model vs post-trained geometry | 2 | include in write-up |
| 2026-05-07_hypothesis_disclosure.md | Hypothesis disclosure strategy | all | ongoing |
| 2026-05-07_fellowship_interview_prep.md | Fellowship interview prep | — | high when needed |
| 2026-05-18_corpus_vs_process.md | Corpus vs process hypotheses | foundational | high |
...
| 2026-05-18_four_condition_stability.md | Four-condition persona stability experiment design | 2 | high |
...
| 2026-05-20_buster_keaton_essay.md | Buster Keaton personal essay concept | personal essay | no deadline |
...
| 2026-05-20_persona_valence_matrix_complete.md | Persona-valence matrix run | 2/4 | complete |
