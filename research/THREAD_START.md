...
Current human-data feasibility result (2026-09-11): `research/outputs/human_trait_dataset_feasibility/` now records the official SAPA V5 and NLSY97 public-use acquisition/audit. SAPA contains 23,679 respondents, 696 items, and 92 administered constructs; reviewed coverage of the 240 canonical model-trait labels is 78 direct/near-direct, 49 close narrow, 41 broad-only, and 72 no defensible match. NLSY97 has 7,044 complete Round-12 TIPI respondents and 6,261 with valid same-wave occupation, but only 2/98 translated persona-role rows reach N>=100 and they share one secretary/administrative-assistant cell; 71 are below N=20. Next step is an independent blinded review of the 78 category-3 SAPA links before any human/model mapping is designed. No respondent was projected, assigned a persona, or analyzed for outcome correspondence; raw human data remain gitignored.
