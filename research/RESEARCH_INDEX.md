...
12. After the user selects a target role, fill the within-role displacement scoring templates, reconstruct the 1,200 selected-role inputs, and run the corrected-hook displacement study only after T01/D01 extraction equivalence is resolved.
