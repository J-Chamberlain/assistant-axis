...
The pre-extraction packet is `analysis_freeze.md`, `hifwb_indicator_inventory.csv`, `hifwb_prompt_freeze.csv`, `hifwb_extraction_questions.csv`, `pre_extraction_verification.json`, and `compute_plan.md`. The guarded extraction/projection scripts and AA-14-shell-based viewer extension are prepared, not run or published. No new indicator activation or projected-coordinate result exists yet.
