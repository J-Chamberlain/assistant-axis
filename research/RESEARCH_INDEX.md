...
13. If judge-model sensitivity is still needed, choose an explicit GPT-5.5 default-temperature protocol or another deterministic model; do not compare GPT-4.1 temperature-0 against GPT-5.5 default-temperature without marking the decoding mismatch.
