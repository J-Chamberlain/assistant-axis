...
7. Run the 240-question bare-Qwen/default extraction-question baseline before future no-label elicitation success criteria are interpreted as movement from unconditioned model behavior; the existing assistant centroid is role-conditioned.
