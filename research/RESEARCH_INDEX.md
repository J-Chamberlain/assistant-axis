...
## AA-8 Bipolar PC1/PC2 Interpretation (2026-09-12)

`research/outputs/qwen_pc1_pc2_bipolar_human_mapping/` is the canonical AA-8 entry point. It reconciles the completed 328 associated, 202 target-dominant, 88 strict-purity, and 70 highly concentrated memberships without rerunning specificity. PC1 is best described as externally legible, standards-governed empirical/procedural discipline versus internally generated expressive-symbolic possibility. PC2 is best described as direct, situated experiential engagement versus inward, abstract, formally mediated integration; coordinate-blind ratings of all 275 role instructions show only modest positive physicality evidence, so embodiment is a secondary ingredient rather than the axis label. The full 126-construct SAPA library and 696-item dictionary were reconsidered, but no single human construct captures either axis and no human respondent was scored or projected.

## Integrated AA-1 Through AA-8 Entry Points (2026-09-12)
...
- AA-8 bipolar PC1/PC2 interpretation and human-measurement inventory: `research/outputs/qwen_pc1_pc2_bipolar_human_mapping/pc1_pc2_bipolar_human_mapping_report.md`
...
PC1: Best described as externally legible, standards-governed empirical/procedural discipline versus internally generated expressive-symbolic possibility. The positive pole combines disciplined knowledge practice, evidence/analysis, correct execution, and accountability to external standards; the negative pole combines narrative, metaphorical, aesthetic, spiritual, intuitive, and improvisational generation. It overlaps with the assistant/evaluator basin but should not be reduced to literal assistantness or broad Conscientiousness. Human analogues are decomposed across Dutifulness, Orderliness, Perfectionism, Cautiousness/Prudence, Control, Intellect, and the opposite pole's Openness/Imagination/Artistic Interests/Absorption/Expressiveness. These are partial measurement bridges, not independent psychometric evidence.

PC2: Best described as direct, situated experiential engagement versus inward, abstract, formally mediated integration. Conditional and trait evidence retain the practical/experiential versus abstract/theoretical contrast; a frozen coordinate-blind audit of all 275 role instructions finds abstract/conceptual and ritual/formal ratings more clearly negative than the modest positive physicality signal. Embodiment is therefore a secondary positive-pole ingredient, not the axis identity. Inverse Intellect and Extraversion are leading but partial human analogues; Traditionalism, Impulsivity, Activity Level, and Adventurousness cover narrower facets or neighbors. Coherent action under unresolved uncertainty remains secondary rather than primary.
