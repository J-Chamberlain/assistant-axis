...
### Axis Specificity Substantially Contracts Qwen Trait Families While Preserving Clean PC1-PC3 Markers (2026-09-12)

Starting from the unchanged 328 correlation-defined Qwen PC1-PC6 signed-family memberships, the specificity rule was frozen before result inspection: the target must remain the largest absolute six-PC correlation in at least 95% of 2,000 fixed-seed role bootstraps and account for at least 70% of the trait's six-PC communality. Eighty-eight memberships survive (26.8%): PC1 retains 12 positive and 48 negative markers, PC2 retains 3/10, PC3 retains 7/8, and PC4-PC6 retain none. The remaining original memberships comprise 150 target-dominant-but-diffuse and 90 non-target-dominant rows. PC scores are mutually uncorrelated to `4.86e-16`, and summed squared correlations reproduce standardized multiple R² to `9.99e-16`.

The filtered PC1-positive family centers on transparent/factual/analytical/methodical/data-driven reasoning rather than broad Conscientiousness; PC1-negative retains its narrative/poetic/symbolic/imaginative core. PC2-positive contracts to experiential/practical/inquisitive, while PC2-negative retains inward abstract-theoretical and ritual/principled content. PC3-positive becomes a clean callous/cynical/pessimistic/vindictive/dominant family; PC3-negative becomes benevolent/nurturing/supportive/altruistic/optimistic care. The existing editorial Affiliation composite is numerically highly PC3-specific (`r=-0.970129`, purity `0.965818`, max off-axis `0.127485`).

A neutral-ID remapping against the unchanged 126-construct SAPA library yields 22 unique construct/item candidates and 195 items: strong whole-family matches remain for PC1-negative and both PC3 poles; both PC2 poles and PC1-positive have partial/component matches; the six empty primary-marker families receive no proposed counterpart. Interpretation: specificity makes several proposed analogues narrower and exposes which strong traits combine axes, but it does not validate human equivalence or make cross-loading psychologically inferior. No respondent was scored/projected, no Llama/Gemma or AA-7 result informed the analysis, and no next experiment was selected.
