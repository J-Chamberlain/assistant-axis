...
### AA-8 Refines Qwen PC1 and PC2 as Bipolar Operating-Mode Axes (2026-09-12)

Using the frozen 328 associated, 202 target-dominant, 88 strict-purity, and 70 highly concentrated memberships as complementary layers, AA-8 finds that PC1 is best described as externally legible, standards-governed empirical/procedural discipline versus internally generated expressive-symbolic possibility. Broad Conscientiousness is therefore downgraded and decomposed: Dutifulness, Orderliness, Perfectionism, Cautiousness/Prudence, Control, and Intellect cover parts of the positive pole, while Openness, Imagination, Artistic Interests, Absorption, and Expressiveness cover parts of the negative pole. No single SAPA construct captures the whole axis.

PC2 is best described as direct, situated experiential engagement versus inward, abstract, formally mediated integration. A frozen coordinate-blind five-dimension rating of all 275 role instructions shows negative associations for abstract/conceptual (`r=-0.322467`) and ritual/formal (`r=-0.254997`) engagement, while embodied/physical engagement is only modestly positive (`r=0.144714`; incremental standardized `Delta R2=0.019355` beyond PC1, practical, and social ratings). Thus embodiment is a secondary positive-pole ingredient, not the axis identity. Inverse Intellect and Extraversion are leading but partial human analogues; Activity Level and Adventurousness remain semantic neighbors rather than physicality measures. The full report and inventories are under `research/outputs/qwen_pc1_pc2_bipolar_human_mapping/`. This is model-side interpretation and measurement availability, not human/model correspondence.
