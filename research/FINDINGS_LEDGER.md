...
## Existing activation sample availability audit (2026-09-24)

Observed within the audited sources: all 1,545 released persona/trait aggregate files match pinned release hashes, but no original response-level persona distributions or trait polarity sets were found for Qwen/Llama/Gemma. This is not evidence that such records were never published or retained. Later local Qwen runs cover four named personas across six role/run pairs, including the separately normalized 104-response trickster pilot. Five main clouds have 1,512 unique IDs and exactly reproduced saved coordinates. Twenty third-party Qwen personas have keyed activation headers, with extraction compatibility and full payload linkage unresolved. Gregariousness's definition/prompts/rubric and aggregates survive; polarity samples and exact weighting do not. AA15's layer-mean correction and AA27's failed bridge gate remain unchanged. Evidence: research/outputs/existing_activation_sample_audit/. No model execution or human comparison.
