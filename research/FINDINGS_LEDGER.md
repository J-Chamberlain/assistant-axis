...
### Frozen PC Trait Specificity Replicates Across LLaMA and Gemma but Preserves Local-Axis Differences (2026-09-12)

AA-10 under `research/outputs/crossmodel_pc_trait_specificity/` exactly recovers all canonical Qwen association and strict marker identities: 328 PC-associated memberships, 202 target-dominant memberships, 88 strict six-PC-purity markers, and 70 highly concentrated memberships. With no retuning, Llama-3.3-70B yields 274 associated / 205 target-dominant / 122 strict / 105 highly concentrated memberships, while Gemma-2-27B yields 297 / 173 / 92 / 72. All 275 shared roles, 240 shared traits, PCs 1-6, original FDR/sign-stability rules, and frozen `.70` purity denominator are preserved.

For Qwen PC2 ↔ LLaMA PC1 ↔ Gemma PC2, the associated layer recurs across all three on positive accessible/experiential/practical and 13 negative inward/abstract/mediated traits. Strict recurrence is pairwise rather than universal: Qwen/LLaMA share practical versus abstract/conceptual/theoretical; Qwen/Gemma share experiential versus erudite/introverted/pensive/principled/reverent/ritualistic/solemn. LLaMA PC1's large poetic/mystical/theatrical/creative negative family carries Qwen-PC1-like content, consistent with the pre-existing LLaMA PC1/PC2 rotation caveat. The cross-model evidence supports a bounded immediate/outward/accessible engagement versus inward/abstract/solemn-formal mediation interpretation, not shared latent homology. Claims 14 and 15 remain unchanged.

Later score correspondence does not guarantee trait specificity: Qwen PC3 matches LLaMA PC4/Gemma PC3 at `r=.802/.806`, but those target PCs have 0/1 strict marker; aligned PC5 has no strict marker in any model. Verification passes 53 checks. No human respondent analysis, human projection, inference, activation extraction, API, GPU, or RunPod was used.
