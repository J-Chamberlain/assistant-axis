...
| A100 activation-cloud posthoc analysis | established / judge pending | amateur/playwright clouds are elongated mostly along PC1, with high PC1/PC2 loading; bootstrap recommends at least 20 retained amateur and 30 retained playwright responses; GPT-4.1 judge scoring attempted but blocked by API quota 429 before any scores | `research/outputs/a100_activation_cloud_posthoc_analysis/cloud_shape_report.md` |
