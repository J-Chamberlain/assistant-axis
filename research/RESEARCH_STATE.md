...
AA-11 repair (2026-09-15): the original `research/outputs/liss_hifwb_prior_evidence/` package contained an off-scope human/model correspondence frame. The repaired active package removes it and is strictly human-only: prior LISS personality–wellbeing evidence, conservative HiFWB mapping, an outcome-blind 2020 analysis freeze, local execution, longitudinal modifiable-pathway planning, and access handoff. Centerdata respondent access remains pending; no respondent files were accessed, no source hashes were fabricated, and no causal or personalized optimization result is claimed. The long-term target is heterogeneous behavior/context pathways to later wellbeing, conditional on prior wellbeing and personality, with within-person and between-person effects separated.
