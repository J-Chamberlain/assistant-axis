...
**Last updated:** 2026-09-11
**Last commit:** c1f241b (merged the five verified AA-1 through AA-5 source histories before final canonical semantic reconciliation)
...
**Current integration update (2026-09-11, AA-1 through AA-5):** Canonically integrated the validated SAPA psychometric, externally anchored Big Five, extended PCA, Qwen sparsity/basis, and NLSY97 occupational-centroid audits without changing their scientific output trees. Claims 1, 16, and 21 now preserve the dimensionality, PC3, and same-space basis-coverage refinements; Claim 6 remains unchanged. The next high-value study is explicitly **FUTURE / NOT YET RUN**: freeze the 12 AA-1 human-supported traits, test how efficiently they recover model-local PC1-PC3 and PC1-PC6 across Qwen/Llama/Gemma, and compare them with AA-4 optimized compact real-trait sets, random real-trait subsets, generic persona-span directions, and AA-2 externally anchored Big Five dimensions. A second future study may align model-local PC1-PC6 score subspaces and compare Big Five directions within the aligned subspace. Neither study was executed during integration.
