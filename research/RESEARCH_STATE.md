...
**Current session update (2026-09-11, externally anchored Big Five audit and viewer integration):** Built `research/outputs/externally_anchored_big_five/` from public-domain IPIP/IPIP-NEO facet structure and the completed AA-1 reviewed SAPA bridge, with no geometry available during mapping. The mapping was frozen at commit `636c5c1d9b832a1199e8d5b35dea993a41f94d4b`: strict uses 42 defensible Big Five assignments among `ACCEPT_DIRECT`; extended adds 25 separately flagged `ACCEPT_CLOSE`; external-taxonomy expanded includes 109 high-confidence direct indicators after all 240 traits were reviewed; the historical hand-predeclared composite remains comparator-only. Strict Qwen Agreeableness strongly aligns with negative PC3 at activation-direction cosine -0.847133, Pearson r=-0.881714, Spearman rho=-0.837526, and single-domain R2=0.777420. Its joint-five standardized beta is -0.894047, in-sample partial R2=0.533524, and held-out partial R2=0.524122; 22.258% single-domain PC3 variance remains. This survives construction and facet sensitivity, but is not a universal PC3 identity: Llama Agreeableness-PC3 is weak and instead aligns with PC2; Gemma has a moderate PC3 association. The PC3 wording is therefore sharpened to “negative Qwen PC3 has a strong Agreeableness-related component,” not replaced with “PC3 is Agreeableness.” Ridge and 3D surface viewers now add Big Five modes while retaining Qwen/editorial defaults and exact prior editorial science (max drift 0.0); deterministic and actual Chrome 152 tests passed across models/profile sets. External anchoring remains same-space evidence, not independent human psychometric validation. Public-site dispatch remains blocked pending access to the existing Site projects/authorized workflow. No GPU, RunPod, new model inference, response generation, activation extraction, or external model API was used.
