...
**Last updated:** 2026-09-13
**Last commit:** 5641ce1 (inventoried cross-model reconciliation artifacts)
...
**Unknown:** Independent experts may further contract the SAPA bridge; whether any discrete human profile count has ontological meaning; whether the K=4 broad patterns replicate in another human dataset; how response style should be modeled; which frozen human representation, if any, is scientifically adequate for later Track 1 comparison; whether human profiles correspond to model-side structure; whether published literature recovers similar profiles; whether aligned recurrence generalizes beyond the three saved-vector releases; and whether selected NLSY97 cells support a later preregistered human-only comparison. AA-7's preregistered gate for designing a human-respondent projection study did not pass.
