...
| Activation-cloud visualization and judge comparison suite | established / GPT-5.5 comparison skipped | standalone viewer created; reusable no-GPU suite scaffolded; GPT-5.5 appeared in model list but rejected required temperature 0, so no substitute judge was run | `research/outputs/a100_activation_cloud_visualization_and_judge_compare/visualization_integration_report.md` |
