...
Updated UTC: 2026-09-11T22:35:00Z
Last commit when updated: 9dd6fd3 (AA-1 feasibility integration before Phase-1b packet freeze)
...
SAPA bridge Phase-1b review: `research/outputs/human_trait_dataset_feasibility/sapa_review/` contains the fixed-seed coordinate-blind review packet for exactly the 78 original Category-3 candidates, the preregistered semantic rubric, an identical decision-free packet and instructions for later external review, and the deterministic packet builder/source manifest. The packet excludes original feasibility labels, geometry, predictors, personas, occupations, outcomes, and downstream performance. The packet freeze precedes Codex adjudication in repository history; this same-workflow review is not independent psychometric validation.
