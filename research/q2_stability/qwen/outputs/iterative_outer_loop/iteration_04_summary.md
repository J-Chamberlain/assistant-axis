...
Mean PCA3D R2: 0.489
Mean baseline PCA3D R2: 0.389
Mean delta: +0.100
Split delta std: 0.034
Mean residual-proxy delta: -0.012
Mean cluster accuracy: 0.622
Mean NN preservation: 0.175

## Rationale

gain=-0.003; stable=True; beats_null=True; complexity_ok=True; decision=discard.
...
## Discarded Candidate Dimensions

- refinement_mythic / mythic_artistic_expression: Poetic, bardic, sage-like, symbolic, expressive, or visionary roles.
- refinement_developmental / developmental_immaturity: Childlike, adolescent, toddler, naive, dependent, playful, or developmentally unstable roles.
- refinement_social_hospitality / hospitality_social_exchange: Bartender, host, merchant, mediator, exchanger, service, conviviality, or social transaction.
- refinement_scale / nonhuman_scale_body: Animal, giant, elemental, tree, whale, machine, object, or nonhuman embodied scale.
- refinement_prediction_control / forecast_control_planning: Forecasting, planning, dispatching, producing, building, controlling, or coordinating future action.
- refinement_judicial_norms / judicial_normative_authority: Judge, law, norm, verdict, purity, realism, standards, justice, or adjudication.

## Top Unexplained Personas

- mechanic: 3/5 splits
- adolescent: 3/5 splits
- prisoner: 3/5 splits
- smuggler: 2/5 splits
- infant: 2/5 splits
- hermit: 2/5 splits
...
- amateur: 2/5 splits
- caveman: 2/5 splits
- bartender: 2/5 splits
- bohemian: 2/5 splits
- vampire: 2/5 splits

## Top Improved Personas

- robot: 4/5 splits
- pragmatist: 3/5 splits
- wind: 2/5 splits
- bard: 2/5 splits
- shaman: 2/5 splits
- facilitator: 2/5 splits
- skeptic: 2/5 splits
- echo: 2/5 splits
- narrator: 2/5 splits
- virus: 2/5 splits
- adolescent: 2/5 splits
- wanderer: 1/5 splits
- aberration: 1/5 splits
- mystic: 1/5 splits
- summarizer: 1/5 splits