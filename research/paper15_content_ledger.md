...
| Human-dataset feasibility, SAPA bridge review, and occupational-centroid stability | Determine whether independent human datasets contain adequate trait content and occupation/outcome overlap for a later correspondence study without running that study. | Official SAPA V5 item/scale release; official NLSY97 public-use extraction and codebook; canonical 240 trait definitions; prior conservative role/occupation mapping; frozen coordinate-blind review packet and rubric; frozen AA-5 stability specification. | Original SAPA 240-trait coverage evidence; NLSY97 same-wave personality/occupation counts and later-outcome inventory; provisional reviewed SAPA bridge with 45 direct and 29 separately flagged close links; AA-5 finds 9 strong and 18 moderate reportable narrow centroids, versus 18 strong and 2 moderate broad-family centroids, with corrected design-based ICCs of 0.008-0.078. | future-work feasibility only; same-workflow Codex review is not independent psychometric validation or human validation of persona geometry, and AA-5 runs no human/model correspondence test |
...
| OQ9 | Does a genuinely independent reviewer retain the frozen provisional SAPA bridge, and can preregistered NLSY97 occupation cells test role-prototype correspondence? | The coordinate-blind same-workflow review retains 45 direct and 29 separately flagged close SAPA links from the original 78. AA-5 finds 27 of 151 reportable narrow occupations and 20 of 22 broad groups meet frozen strong/moderate stability criteria, but corrected occupation ICCs are only 0.008-0.078, most exact model-role mappings remain sparse, and no correspondence analysis has run. |
...
| SAPA/NLSY97 feasibility audit, occupational-centroid stability study, and provisional SAPA bridge as a Paper 1.5 result | Use only to motivate carefully bounded future independent validation; the reviewed bridge is provisional, the same-workflow Codex review is not independent psychometric validation, and none of these artifacts validates human/model correspondence or belongs in the current geometry evidence chain. |
