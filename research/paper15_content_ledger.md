...
| Human-dataset feasibility audit | Determine whether independent human datasets contain adequate trait content and occupation/outcome overlap for a later correspondence study without running that study. | Official SAPA V5 item/scale release; official NLSY97 public-use extraction and codebook; canonical 240 trait definitions; prior conservative role/occupation mapping. | SAPA 240-trait coverage evidence; NLSY97 same-wave personality/occupation counts and later-outcome inventory. | future-work feasibility only; not human validation of persona geometry |
...
| OQ9 | Can an independently reviewed subset of SAPA item content support a defensible human/model trait bridge, and can preregistered NLSY97 occupation cells test role-prototype correspondence? | Feasibility audit finds 78 direct/near-direct SAPA links and 6,261 Round-12 TIPI-plus-occupation respondents, but most mapped persona-role cells are sparse and no correspondence analysis has been run. |
...
| SAPA/NLSY97 feasibility audit as a Paper 1.5 result | Use only to motivate carefully bounded future independent validation; it neither validates human correspondence nor belongs in the current geometry evidence chain. |
