...
Do not start with broad repo archaeology for provenance questions. Check `RESEARCH_INDEX.md` and `PROVENANCE_REGISTRY.md` first, then verify locally only if the answer is absent, stale, or high-stakes.
