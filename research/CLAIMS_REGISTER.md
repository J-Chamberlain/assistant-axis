...
## Aggregate Rosetta translation

Claim: Frozen aggregate human/model profile correspondence does not currently yield a supported low-complexity translation beyond identity on held-out target traits.
Status: Observed
Evidence: `research/outputs/human_model_rosetta_translation/translation_model_comparison.csv`, `translation_null_results.csv`, and `human_model_rosetta_translation_report.md`. Across 24 held-out matched-pair folds, identity averaged target Pearson r=0.1500; the best non-identity candidate decreased r by 0.1602. Cluster-pairing, trait-label, and joint-structure null p-values were 0.9305, 0.8996, and 1.0000.
Counterevidence: The earlier AA-12 aggregate correspondence itself remains a strong aggregate profile-shape result under its own frozen design; this follow-up tests translation of recurring profile differences, not the existence of correspondence.
Dependencies: `research/outputs/human_model_profile_correspondence/`, `research/outputs/human_model_rosetta_translation/`
