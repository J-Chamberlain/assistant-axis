...
Claim: Complete same-model trait-vector profiles substantially predict held-out persona PCA location in the released Qwen/Qwen3-32B, Llama-3.3-70B, and Gemma-2-27B vector sets. In Qwen, compact selected trait sets outperform matched generic bases at small feature counts, while a large generic basis nearly recovers the complete-bank result; the evidence therefore supports a mixture of trait-specific alignment and same-space basis coverage.
Status: Observed
Evidence: Qwen complete-profile evidence remains raw Ridge LOPO R2=0.999522/0.998811/0.999611 with normalized 3D RMSE=0.045378. The Qwen sparsity audit established that PCA is fit to 275 mean-pooled 5,120-dimensional role vectors and does not use the named traits, while both targets and predictors transform those same role vectors. Leakage-safe nested selection reached all-PC R2>=0.95 with 3 traits, >=0.98 with 4, and >=0.99 with 6; selected 5/10/15-trait normalized RMSE was 0.176511/0.106880/0.087216. The fixed editorial 15 reached 0.165056, versus random-real-15 median 0.153307. Selected 15 beat all 100 matched random-real, isotropic, and fold-local persona-span banks; their median normalized RMSE was 0.153307/0.737911/0.170184. At k=240, however, the fold-local persona-span generic basis reached 0.051422 versus repeated full-real 0.047609. The full 240-trait activation-space span contains 98.7955%/98.5303%/98.1947% of the canonical PC1/PC2/PC3 loading directions. The compact target-permutation null remained near/below chance. Llama and Gemma evidence remains raw Ridge LOPO R2=0.997833/0.997161/0.989900 and 0.999788/0.996179/0.987835, with their previously reported family, permutation, and synthetic controls.
Counterevidence: The high-k fold-local random persona-span control nearly matches the full real-trait bank, and the full trait span directly covers more than 98% of every PC loading, showing that much of the near-ceiling result is generic same-space basis coverage. The fixed editorial 15 is slightly worse than a median random real-trait subset of the same size. Exact trait identity is unstable under redundancy: 2,178 pairs have absolute cross-persona correlation >=0.90, including large interchangeable families. Compact selected real traits retain a genuine matched-prediction advantage at small k, but this does not establish that their labels form a causal or independently validated psychological ontology. Qwen remains more precise than the Llama/Gemma replications; cross-model PC orientation does not establish identical semantics; behavioral realization by a genuinely new elicited persona remains untested; accuracy does not measure psychological sophistication or human-likeness.
Dependencies: `research/outputs/trait_persona_prediction/trait_predicts_persona_pcs_report.md`, `research/outputs/trait_profile_pc_predictor/`, `research/outputs/qwen_trait_sparsity_prediction/qwen_trait_sparsity_report.md`, `research/outputs/qwen_trait_sparsity_prediction/matched_basis_comparison.csv`, `research/outputs/qwen_trait_sparsity_prediction/trait_span_pc_coverage.csv`, `research/outputs/qwen_trait_sparsity_prediction/validation_summary.json`, `research/outputs/multimodel_trait_profile_pc_predictor/multimodel_trait_profile_pc_predictor_report.md`, `research/outputs/multimodel_trait_profile_pc_predictor/cross_model_comparison.csv`
Last Updated: 2026-09-11
