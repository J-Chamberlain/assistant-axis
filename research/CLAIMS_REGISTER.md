...
Claim: Complete same-model trait-vector profiles substantially predict held-out persona PCA location in the released Qwen/Qwen3-32B, Llama-3.3-70B, and Gemma-2-27B vector sets, supporting an approximately linear same-space basis-coverage interpretation.
Status: Observed
Evidence: Qwen observed: raw Ridge LOPO R2=0.999522/0.998811/0.999611, Qwen-canonical cluster-holdout R2=0.998692/0.997740/0.999338, permutation p95 mean R2=-0.007548, and endpoint-held-out synthetic R2=0.995266/0.984377/0.997144. Llama observed: raw Ridge LOPO R2=0.997833/0.997161/0.989900, fixed Qwen-canonical role-family holdout R2=0.993894/0.993627/0.977094, permutation p95=-0.009359, and synthetic R2=0.983420/0.982280/0.946688. Gemma observed: raw Ridge LOPO R2=0.999788/0.996179/0.987835, fixed family holdout R2=0.999271/0.993851/0.975087, permutation p95=-0.011572, and synthetic R2=0.999557/0.980280/0.969824. Ridge remains selected for all three under the same predeclared model rule.
Counterevidence: All features and targets are high-dimensional transformations of role/trait vectors from the same model activation space, so strong prediction is basis coverage/provenance coupling rather than independent psychological explanation. Qwen has lower normalized LOPO, family-holdout, and synthetic RMSE than the replications; Llama/Gemma PC3 and distant-pair synthetic errors are larger; fold-safe quantiles are less precise in all models; complete role-family holdout is harder; behavioral realization by a genuinely new elicited persona remains untested. Cross-model PC orientation does not establish identical axis semantics, and accuracy does not measure psychological sophistication or human-likeness.
Dependencies: `research/outputs/trait_persona_prediction/trait_predicts_persona_pcs_report.md`, `research/outputs/trait_profile_pc_predictor/`, `research/outputs/multimodel_trait_profile_pc_predictor/multimodel_trait_profile_pc_predictor_report.md`, `research/outputs/multimodel_trait_profile_pc_predictor/cross_model_comparison.csv`, `research/outputs/multimodel_trait_profile_pc_predictor/llama/validation_summary.json`, `research/outputs/multimodel_trait_profile_pc_predictor/gemma/validation_summary.json`
Last Updated: 2026-09-11
