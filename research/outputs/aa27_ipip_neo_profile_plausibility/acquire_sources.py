...
(OUT/'source_manifest.json').write_text(json.dumps(dict(model_used='GPT-6 Astra',thinking='High',repository='https://osf.io/tbmh5/',dataset_node='https://osf.io/wxvth/',key_node='https://osf.io/ycvdk/',sources=records,reuse_conditions={'item_materials':'IPIP public domain; official permission page','dataset_node_license':None,'dataset_explicit_license_found':False,'dataset_statement':'Public Johnson OSF repository makes these research data available; item public-domain status is not asserted as a dataset license','dataset_metadata_url':'https://api.osf.io/v2/nodes/wxvth/','item_permission_url':'https://ipip.ori.org/newPermission.htm'},raw_data_gitignored=True,respondent_outputs_permitted=False),indent=2)+'\n')
