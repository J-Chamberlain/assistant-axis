...
def main():
 ...
 labels={'content_balanced_ge2':'General Wellbeing','affect':'Affect','appraisal':'Appraisal','meaning_making':'Meaning Making','self_concept':'Self Concept','interpersonal_relationships':'Interpersonal Relationships','content_balanced_ge3':'Stricter General Wellbeing Coverage','historical_13':'Historical 13-item Composite','non_affect':'Non-Affect Sensitivity','vitality':'Vitality'}
 details={'content_balanced_ge2':{'lens':'Shared wellbeing proxy','content':'Equal-weighted available HiFWB content areas','items':13,'status':'primary','caveat':'Community unavailable; not a validated latent h factor'},'affect':{'lens':'Subjective wellbeing','content':'Affect','items':4,'status':'content','caveat':'Frozen SAPA direct mapping'},'appraisal':{'lens':'Subjective wellbeing','content':'Appraisal','items':2,'status':'content','caveat':'Frozen SAPA direct mapping'},'meaning_making':{'lens':'Psychological wellbeing','content':'Meaning-making','items':1,'status':'content','caveat':'Sparse SAPA content coverage'},'self_concept':{'lens':'Psychological wellbeing','content':'Self-concept','items':4,'status':'content','caveat':'Frozen SAPA direct mapping'},'interpersonal_relationships':{'lens':'Social wellbeing','content':'Interpersonal relationships','items':1,'status':'content','caveat':'Sparse SAPA content coverage'},'content_balanced_ge3':{'lens':'Shared wellbeing proxy','content':'Stricter content-balanced sensitivity','items':13,'status':'advanced','caveat':'Requires at least 3 available content areas'},'historical_13':{'lens':'Exploratory composite','content':'Historical 13-item score','items':13,'status':'advanced','caveat':'Original AA-10 exploratory composite'},'non_affect':{'lens':'Sensitivity','content':'Non-affect direct items','items':9,'status':'advanced','caveat':'Sensitivity analysis only'},'vitality':{'lens':'Auxiliary','content':'Vitality','items':1,'status':'advanced','caveat':'Not an HiFWB core content'}}
 bundle={'axes':names,'outcomes':{k:{'label':labels.get(k,k.replace('_',' ').title()),'N':v['N'],'mean':v['mean'],'sd':v['sd'],'details':details.get(k,{})} for k,v in coeff.items()},'coefficients':coeff,'grid':rows,'support':support,'defaults':{'x':'Extraversion','y':'Emotional Stability','outcome':'content_balanced_ge2','mode':'empirical'},'hierarchy':{'General Wellbeing':'HiFWB-aligned proxy; not latent h','Subjective wellbeing':['Affect','Appraisal'],'Psychological wellbeing':['Meaning Making','Self Concept'],'Social wellbeing':['Community (unavailable)','Interpersonal Relationships']},'source':{'dataset':'SAPA V5','respondents':23679,'terrain_N':int(elig.sum()),'tab_sha256':hashlib.sha256(TAB.read_bytes()).hexdigest()}}
